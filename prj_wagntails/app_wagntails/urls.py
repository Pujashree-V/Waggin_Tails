...
########### Chat Related ##########
    ...
    path('chatMessage/<str:sender>/<str:receiver>/<str:pk>/', views.message_view, name='chat'),
    path('api/messages/<int:sender>/<int:receiver>/', views.message_list, name='message-detail'),
    path('api/messages/', views.message_list, name='message-list'),
    path('chatMessageSubmit/<int:sender>/<int:receiver>/', views.chatMessageSubmit, name='chatSubmit'),
